def back_fast():
	...
	times.append(times_v)
	keys.append([0.0, 0.0, -1.2361, -1.0186])

	names.append("LAnklePitch")
	times.append(times_v)
	keys.append([0.0, 0.0, -1.2361, -1.0189])
	...
	times.append(times_v)
	keys.append([0.0293, -1.77, 0.48, 0.48])

	names.append("LHipPitch")
	times.append(times_v)
	keys.append([0.0156, -1.77, 0.48, 0.48])
	...
	times.append(times_v)
	keys.append([-2, 1.5962, 1.9524, 2.0762])

	names.append("LShoulderPitch")
	times.append(times_v)
	keys.append([-2, 1.5954, 1.9519, 2.0762])

	names.append("RElbowRoll")
	times.append(times_v)
	keys.append([0.0, 0.9282, 1.3476, 1.3133])
